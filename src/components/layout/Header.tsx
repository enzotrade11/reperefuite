    ...
    <>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-[80px] sm:h-[100px] lg:h-[148px]">
            {/* Logo */}
            <Link href="/" className="flex items-center shrink-0">
              <Image
                ...
                width={460}
                height={690}
                className="h-[72px] sm:h-[90px] lg:h-[140px] w-auto object-contain"
                priority
              />
            </Link>
      ...
      {/* Spacer — compense le header fixe */}
      <div className="h-[120px] sm:h-[136px] lg:h-[170px]" />
    </>
  )
}
